# UPGRADE_BASELINE — Rode baseline golden corpus (Fase A2)

**Datum:** 2026-07-02 · **Code:** branch `upgrade/fase-a-golden-corpus` (main 63fa5fe + PR#5, géén fixes) · **Pijplijn:** verse LLM-extractie (`LLM_CACHE_MODE=off`), volledige ingest-graph, prod-masterdata read-only gespiegeld, `NAVISION_MODE=mirror`.

**Runner:** `backend/scripts/upgrade_baseline.py` · ruwe output: `backend/_upgrade/baseline.json` (gitignored; dit rapport bevat de VOLLEDIGE per-order-output, niets samengevat).

**Oordeel-definitie (streng):** JUIST | FOUT-met-vlag (fout maar reviewer wordt gewezen) | **STILLE-FOUT** (fout zonder vlag = FAIL-klasse). Alleen velden met een grondwaarheid in `backend/tests/corpus/ground_truth.json` worden beoordeeld.

## Totaal

| n orders | stille fouten | fout-met-vlag | juist | crashes |
|---|---|---|---|---|
| 17 | **3** | 4 | 12 | 0 |

**Masterdata-tellingen (prod-schaarste zichtbaar):** klantenkaarten=1787, klant_email_aliases=1, klantenkaart_ship_to=2506, artikelkaarten=3757, artikel_eenheden=12963, klantenkaart_artikelen=24, artikel_kruisverwijzing=3000, artikel_matching_history=24, artikel_pallet_kennis=19, prijsafspraken=0

## Uitslag per order (overzicht)

| # | order | bron-type | status | niet-JUIST velden |
|---|---|---|---|---|
| 944 | BAUHAUS 1049577521 | tekst_reconstructie | **JUIST** | — |
| 954 | TABS 4506877460 | state_met_pdf | **JUIST** | — |
| 941 | PPG/Driessen XO092614 | tekst_reconstructie | **JUIST** | — |
| 847 | Werkzeuge Dietrich -> se Huber (Strecken) | state_met_pdf | **STILLE-FOUT** | klant_nr: verwacht '61532' kreeg None (FOUT-met-vlag); ship_to_code: verwacht '94315' kreeg None (STILLE-FOUT) |
| 819 | Nexttcom afhaalorder (4 Paletten 23691) | tekst_reconstructie | **JUIST** | — |
| 845 | Lasaulec INK0090679 (art. 15620) | tekst_reconstructie | **review** | regel1.eenheid: verwacht 'PALLET' kreeg 'STUK' (FOUT-met-vlag) |
| 203 | Lasaulec INK0084314 (2e Lasaulec-order, generiek-bewijs) | tekst_reconstructie | **review** | regel1.eenheid: verwacht 'PALLET' kreeg 'STUK' (FOUT-met-vlag); regel2.artikel: verwacht '224681' kreeg None (FOUT-met-vlag) |
| 816 | Zevij-portaal IOR26-008934 | tekst_reconstructie | **JUIST** | — |
| 832 | TABS 4506870435 -> PontMeyer Zoetermeer | state_met_pdf | **STILLE-FOUT** | europallet_aantal: verwacht 1 kreeg 2 (STILLE-FOUT) |
| 833 | TABS 4506870437 -> PontMeyer Heemstede | state_met_pdf | **STILLE-FOUT** | europallet_aantal: verwacht 1 kreeg None (STILLE-FOUT) |
| 834 | TABS 4506870444 -> PontMeyer Zwaag (2e agent-order, generiek-bewijs) | state_met_pdf | **JUIST** | — |
| 716 | Würth 0095588334 (regressie + F3-anker) | state_met_pdf | **JUIST** | — |
| 717 | Kuipers BMH 20173111 (regressie) | tekst_reconstructie | **JUIST** | — |
| 718 | Witzand PN50040984 (regressie, mix-klant) | tekst_reconstructie | **JUIST** | — |
| 721 | Van Dongen 2601382 (regressie) | state_met_pdf | **JUIST** | — |
| 707 | GBI Borne 2601922 via Zevij-portaal (regressie) | tekst_reconstructie | **JUIST** | — |
| 685 | Veris 822200 (regressie, mix-klant) | tekst_reconstructie | **JUIST** | — |

## Volledige per-order-output (letterlijk uit baseline.json)
...
```json
{
  ...
  "samenvatting": {
    ...
    "regels": [
      {
        ...
        "art_klant": "804600",
        "art_matched": "23559",
        "oms": "ProGold Afdekvlies ETP 25m2",
        "hoeveelheid": 45.0,
        "eenheid": "STUK",
        "eenheid_origineel": "STUK",
        "eenheid_default": "STUK",
    ...
    "europallet": {
      ...
      "uitleg": "5.875 pallets in order → 6 europallets (afgerond naar boven).",
      "onderbouwing_regels": [
        {
          "artikelnr": "23559",
          "qty": 45.0,
  ...
  "samenvatting": {
    ...
    "klant": {
      ...
      "kandidaten": [
        ...
        {
          "nr": "60600",
          "naam": "Späth Knoll GmbH"
        },
        {
          "nr": "60637",
          "naam": "Engel & Jung GmbH + Co KG Groß-und Einzelhandel"
        },
        {
          "nr": "61514",
          "naam": "se Huber Augsburg GmbH & Co. KG"
        },
        {
          "nr": "61515",
          "naam": "se Huber Feldkirchen GmbH & Co KG"
        },
        {
          "nr": "61516",
          "naam": "Weicken & Schmidt GmbH"
        }
      ]
    },
    ...
    "validatie_warnings": [
      "⚠ MEERDERE KLANTEN mogelijk voor '@werkzeuge-dietrich.de' — geen unieke match. Handmatige selectie nodig. Kandidaten: 61532 (se Huber Straubing GmbH & Co KG), 61816 (se Huber GmbH & Co KG), 60103 (Werkzeuge Dietrich GmbH & Co KG), 60600 (Späth Knoll GmbH), 60637 (Engel & Jung GmbH + Co KG Groß-und Einzelhandel), 61514 (se Huber Augsburg GmbH & Co. KG), 61515 (se Huber Feldkirchen GmbH & Co KG), 61516 (Weicken & Schmidt GmbH)",
...
```json
{
  ...
  "samenvatting": {
    ...
    "validatie_warnings": [
      "⚠ KLANT IS GEEN 4+ LID — controleer aankoopvoorwaarden",
      "⚠ EENHEID CONTROLEREN (regel 1): klant bestelde 'PAL' maar dit is geen geldige eenheid voor artikel 15620 (gebruikt nu standaard 'STUK')."
    ],
    "is_order": true
  },
  "oordeel": {
...
```json
{
  ...
  "samenvatting": {
    "extract": {
      ...
      "taal": "NL",
      "afleveradres": {
        "naam": "Lasaulec BV - Centraal magazijn",
        "straat": "A Kûper 2",
        "postcode": "8447 GK",
        "plaats": "Heerenveen",
        "land": "NL"
...
```json
{
  ...
  "samenvatting": {
    ...
    "europallet": {
      ...
      "uitleg": "1.375 pallets in order → 2 europallets (afgerond naar boven).",
      "onderbouwing_regels": [
        {
          "artikelnr": "238601",
          "qty": 33.0,
...
```json
{
  ...
  "samenvatting": {
    ...
    "europallet": {
      "regel": null,
      "uitleg": "0.208 pallets in order — onder de drempel, geen europallet.",
      "onderbouwing_regels": [
        {
          "artikelnr": "229231",
          "qty": 5.0,
...
```json
{
  ...
  "samenvatting": {
    ...
    "europallet": {
      ...
      "uitleg": "2.75 pallets in order → 3 europallets (afgerond naar boven).",
      "onderbouwing_regels": [
        {
          "artikelnr": "238601",
          "qty": 66.0,
...
```json
{
  ...
  "samenvatting": {
    "extract": {
      "klantnaam_besteller": "Van Dongen Verf B.V.",
